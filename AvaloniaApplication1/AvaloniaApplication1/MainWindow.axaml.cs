...
namespace AvaloniaApplication1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void WriteFile(object sender, RoutedEventArgs e)
        {
            ...
            //string data = $"{person.surname};{person.name};{person.otvestvo};{person.phone};" +
            //              $"{birthDate.ToString("dd.MM.yyyy")};{person.pol};{dayOfWeek};{slavicSign}";
            // запись а файл
        ...
        // Преобразование названия месяца в его номер
        ...
        // Определение знака древнеславянского гороскопа
        ...
        {
            // Скрытие формы ввода и отображение списка пользователей
